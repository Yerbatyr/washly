        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="space-y-4 mb-8">
            <Button 
              variant="hero" 
              size="xl" 
              className="w-full sm:w-auto px-4 sm:px-8 md:px-12 py-3 sm:py-4 md:py-6 text-sm sm:text-base md:text-xl font-bold bg-green-500 hover:bg-green-600 animate-[buttonGlow_2s_ease-in-out_infinite] shadow-[0_0_30px_rgba(34,197,94,0.6)]"
