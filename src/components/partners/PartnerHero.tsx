      ...
      <div className="container mx-auto px-4 relative">
        <div className="max-w-5xl mx-auto text-center text-white [&_*]:drop-shadow-[0_2px_8px_rgba(0,0,0,0.8)]">
          ...
          <p className="text-xl lg:text-2xl text-white/90 mb-8 font-medium max-w-4xl mx-auto animate-fade-in">
            Забудьте про пустые дни и проблемы с персоналом. <span className="bg-gradient-to-r from-primary via-white to-primary bg-clip-text text-transparent animate-[gradient_3s_ease-in-out_infinite] bg-[length:200%_auto] font-bold">Washly</span> 
            привлечет <span className="bg-gradient-to-r from-primary via-white to-primary bg-clip-text text-transparent animate-[gradient_3s_ease-in-out_infinite] bg-[length:200%_auto] font-bold">10,000+ готовых платить клиентов</span> прямо к вашей мойке
          </p>
